...
const ServiceSection = () => {
  return (
    <div className="bg-[#fff] container mx-auto px-6 text-black py-20 pt-26">
      <div className="container px-6 mx-auto flex items-start justify-center md:flex-row flex-col gap-16 ">
        ...
        <div className="md:h-[400px] h-[200px]">
          ...
          <div className="relative w-full max-w-sm h-full bg-[#b22a2a] overflow-hidden group shadow-2xl">
        ...
        <div className="flex flex-col justify-between h-auto py-4">
          <div className="flex flex-col md:flex-row gap-10 mb-10">
            <div className="space-y-2">
              <span className="text-5xl md:text-6xl font-bold tracking-tighter text-[#b22a2a] italic mb-4 block">3+</span>
              <p className="text-zinc-500 text-sm font-medium uppercase tracking-widest">Warehouses</p>
            </div>

            <div className="md:ml-10">
              <span className="text-5xl md:text-6xl font-bold text-[#b22a2a] tracking-tighter italic mb-4 block">40+</span>
